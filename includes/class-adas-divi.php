...
class Adas_Divi {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-adas-divi-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'includes/class-adas-divi-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'admin/class-adas-divi-admin.php';
		require_once plugin_dir_path( __DIR__ ) . 'admin/class-adas-divi-settings.php';
		require_once plugin_dir_path( __DIR__ ) . 'admin/class-adas-divi-khwidget.php';
		require_once plugin_dir_path( __DIR__ ) . 'admin/adas-enqueue.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( __DIR__ ) . 'public/class-adas-divi-public.php';
		require_once plugin_dir_path( __DIR__ ) . 'public/class-adas-divi-shortcode.php';
		require_once plugin_dir_path( __DIR__ ) . 'public/class-divi-khdb.php';
		require_once plugin_dir_path( __DIR__ ) . 'public/class-divi-khpdf.php';
		require_once plugin_dir_path( __DIR__ ) . 'public/class-divi-khcsv.php';
